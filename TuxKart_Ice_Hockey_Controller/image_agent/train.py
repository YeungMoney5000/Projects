...
def train(args):
    ...
    files = ['ai1.pkl','ai2.pkl',"geoffrey1.pkl","geoffrey2.pkl","yoshua1.pkl","yoshua2.pkl","jurgen1.pkl","jurgen2.pkl"]
    train_images = []
    train_labels = []
    print("data opened")
    for file in files:
    ...
    optimizer = torch.optim.Adam(action_net.parameters(), lr=0.0005, weight_decay=0.00001)
    ...
    for epoch in range(n_epochs):
        ...
        for iteration in range(0, len(train_images), batch_size):
            ...
            loss_val = loss_accel * .01 + loss_steer * .69 + loss_brake * .3
